...
namespace Plugin.Sample.Promotions.Generator
{
    ...
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName("PromotionsToEvaluateBlock")]
	public class PromotionsToEvaluateBlock : PipelineBlock<IEnumerable<Promotion>, IEnumerable<Promotion>, CommercePipelineExecutionContext>
	{
        /// <summary>
        /// The execute.
        /// </summary>
        ...
        public override Task<IEnumerable<Promotion>> Run(IEnumerable<Promotion> arg, CommercePipelineExecutionContext context)
		{
            ...
            if (cart != null)
            {
                cart.GetComponent<MessagesComponent>().AddMessage(
                                ...
                                $"PromotionsToEvaluate.PromotionsRemaining: {arg.Count()}");
            }
