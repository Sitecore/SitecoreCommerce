...
namespace Plugin.Sample.Promotions.Generator
{
    ...
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName("EvaluatePromosFilterByCoupon")]
	public class EvaluatePromosFilterByCoupon : PipelineBlock<IEnumerable<Promotion>, IEnumerable<Promotion>, CommercePipelineExecutionContext>
	{
        /// <summary>
        /// The execute.
        /// </summary>
        ...
        public override Task<IEnumerable<Promotion>> Run(IEnumerable<Promotion> arg, CommercePipelineExecutionContext context)
		{
            ...
            if (cart != null)
            {
                cart.GetComponent<MessagesComponent>().AddMessage(
                                ...
                                $"EvaluatePromosFilterByCoupon.{benefitType.Name}.PromotionsRemaining: {arg.Count()}");
            }
