...
namespace Plugin.Sample.Promotions.Generator
{
    ...
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName("EvaluatePromosFilterNotApproved")]
	public class EvaluatePromosFilterNotApproved : PipelineBlock<IEnumerable<Promotion>, IEnumerable<Promotion>, CommercePipelineExecutionContext>
	{
        /// <summary>
        /// The execute.
        /// </summary>
        ...
        public override Task<IEnumerable<Promotion>> Run(IEnumerable<Promotion> arg, CommercePipelineExecutionContext context)
		{
            ...
            if (cart != null)
            {
                cart.GetComponent<MessagesComponent>().AddMessage(
                                ...
                                $"EvaluatePromosFilterNotApproved.PromotionsRemaining: {arg.Count()}");
            }
