...
namespace Plugin.Sample.Promotions.Generator
{
    ...
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName("EvaluatePromosFilterByItems")]
	public class EvaluatePromosFilterByItems : PipelineBlock<IEnumerable<Promotion>, IEnumerable<Promotion>, CommercePipelineExecutionContext>
	{
        /// <summary>
        /// The execute.
        /// </summary>
        ...
        public override Task<IEnumerable<Promotion>> Run(IEnumerable<Promotion> arg, CommercePipelineExecutionContext context)
		{
            ...
            if (cart != null)
            {
                cart.GetComponent<MessagesComponent>().AddMessage(
                                ...
                                $"EvaluatePromosFilterByItems.PromotionsRemaining: {arg.Count()}");
            }
