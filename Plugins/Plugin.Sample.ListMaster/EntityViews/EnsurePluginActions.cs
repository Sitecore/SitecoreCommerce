    ...
    public class EnsurePluginActions : PipelineBlock<EntityView, EntityView, CommercePipelineExecutionContext>
    {
        ...
        public override async Task<EntityView> Run(EntityView entityView, CommercePipelineExecutionContext context)
        {
            ...
            if (pluginPolicy.IsDisabled)
            {
                ...
                {
                    Name = $"Roles.EnablePlugin.Plugin.Sample.ListMaster",
                    DisplayName = $"Enable ListMaster",
                    Description = $"Enable ListMaster",
            ...
            else
            {
                actionsPolicy.Actions.Add(new EntityActionView
                {
                    Name = $"Roles.DisablePlugin.Plugin.Sample.ListMaster",
                    DisplayName = $"Disable Plugin (Plugin.Sample.ListMaster)",
                    Description = $"Disable Plugin (Plugin.Sample.ListMaster)",
                    IsEnabled = true,
