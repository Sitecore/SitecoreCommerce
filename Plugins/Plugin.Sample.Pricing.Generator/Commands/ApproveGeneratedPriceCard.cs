...
namespace Plugin.Sample.Pricing.Generator
{
    ...
    /// <summary>
    /// Defines the ApproveGeneratedPriceCard command.
    /// </summary>
    public class ApproveGeneratedPriceCard : CommerceCommand
    {

        private readonly CommerceCommander _commerceCommander;

        /// <summary>
        /// Initializes a new instance of the <see cref="ApproveGeneratedPriceCard"/> class.
        /// </summary>
        /// <param name="commerceCommander">The <see cref="CommerceCommander"/> is a gateway object to resolving and executing other Commerce Commands and other control points.</param>
        public ApproveGeneratedPriceCard(CommerceCommander commerceCommander)
        {
        ...
        public async Task<bool> Process(CommerceContext commerceContext, Promotion promotion, List<Policy> policies = null)
        {
            using (var activity = CommandActivity.Start(commerceContext, this))
            {
                ...
                {
                    commerceContext.Logger.LogWarning($"DoActionGeneratePriceBook.ApprovalRequestDenied: PromotionId={createdPromotion.Id}");
                }
