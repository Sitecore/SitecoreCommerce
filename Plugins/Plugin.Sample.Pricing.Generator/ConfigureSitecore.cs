        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Sitecore().Pipelines(config => config
             ...
             .ConfigurePipeline<IDoActionPipeline>(
              ...
              .ConfigurePipeline<IResolveActivePriceSnapshotByTagsPipeline>(
                configure => configure.Replace<Sitecore.Commerce.Plugin.Pricing.FilterPriceSnapshotsByTagsBlock, FilterPriceSnapshotsByTagsBlock>())
                );
