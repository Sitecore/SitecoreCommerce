    ...
    public class EnsureActions : PipelineBlock<EntityView, EntityView, CommercePipelineExecutionContext>
    {
        ...
        public override Task<EntityView> Run(EntityView entityView, CommercePipelineExecutionContext context)
        {
            ...
            if (entityView.Name == "ComposerDashboard")
            {
                ...
                {
                    var tableEntityViewActionsPolicy = composerTemplatesView.GetPolicy<ActionsPolicy>();

                    //This action adds a SampleDashboardEntity
                    tableEntityViewActionsPolicy.Actions.Add(new EntityActionView
                    {
                        Name = "ComposerDashboard-AddTagToTemplate",
                        DisplayName = "Adds a tag to a Template",
                        Description = "Adds a tag to a Template",
                        IsEnabled = true,
                        RequiresConfirmation = false,
                        EntityView = "ComposerDashboard-FormAddTagToTemplate",
                        Icon = "add"
                    });
                }
