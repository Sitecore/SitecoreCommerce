...
namespace Plugin.Sample.Promotions.Generator
{
    ...
    /// <summary>
    /// Defines a PromotionBookSample
    /// </summary>
    /// <seealso cref="Sitecore.Commerce.Core.Model" />
    public class PromotionBookSample : Model
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionBookSample"/> class.
        /// </summary>
        public PromotionBookSample()
        {
