    ...
    public class ApproveGeneratedPromotion : CommerceCommand
    {
        ...
        public async Task<bool> Process(CommerceContext commerceContext, Promotion promotion, List<Policy> policies = null)
        {
            using (var activity = CommandActivity.Start(commerceContext, this))
            {
               ...
               commerceContext.Messages.Add(new CommandMessage { Code = "Information", CommerceTermKey = "PromotionBeingApproved", Text = "Promotion Being Approved!" });
                ...
                {
                    commerceContext.Messages.Add(new CommandMessage { Code = "Information", CommerceTermKey = "PromotionApproved", Text = "Promotion Approved!" });
                }
