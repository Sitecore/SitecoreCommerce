...
{
    using Plugin.Sample.BizFx.Enhancements.EntityViews;
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Sitecore().Pipelines(config => config
             ...
             .ConfigurePipeline<IFormatEntityViewPipeline>(d =>
                 {
                     d.Add<EnsureSellableItemImages>().After<PopulateEntityViewActionsBlock>()
                      .Add<EnsurePriceCardSnapshots>().After<PopulateEntityViewActionsBlock>();
                 })
